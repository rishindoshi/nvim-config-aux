...
keymap.set("n", "<leader>,", "<cmd>Telescope find_files theme=dropdown<cr>") -- toggle find files
keymap.set("n", "<leader>b", "<cmd>Telescope buffers theme=dropdown<cr>") -- toggle find files
